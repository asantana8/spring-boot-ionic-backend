...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "41027130003", TipoCliente.PESSOAFISICO);
		cli1.getTelefones().addAll(Arrays.asList("81998773504", "81998993816"));

		Cliente cli2 = new Cliente(null, "Falseane Hofman", "fhofman@gmail.com", "81250268001",
				TipoCliente.PESSOAFISICO);

		cli1.getTelefones().addAll(Arrays.asList("81998773504", "81998993816"));
		cli2.getTelefones().addAll(Arrays.asList("8133145478", "81986218818"));
		...
		Endereco e3 = new Endereco(null, "Rua Paes Cabral", "301", "Apto.2", "Cordeiro", "50190190", cli2, cid3);
